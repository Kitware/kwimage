...
Notes:
    ...
    rm -rf ~/code/kwimage/docs/source/auto
...
mod_dpath = join(repo_dpath, 'kwimage')
...
latex_documents = [
    (master_doc, 'kwimage.tex', 'kwimage Documentation', 'Jon Crall', 'manual'),
]
...
man_pages = [(master_doc, 'kwimage', 'kwimage Documentation', [author], 1)]
